...
class BiLSTM(nn.Module):
    ...
    def __init__(self, vocab_size, alphabet_size, word_embedding_dim, char_embedding_dim, hidden_dim, char_hidden_dim, num_of_tags, dropout, use_crf=False, use_char=False):
        ...
        self.char_embedding = CharCNN(alphabet_size, char_embedding_dim, char_hidden_dim, dropout)
    ...
    def forward(self, sent, chars):
        ...
        #print("word_embedding shape: " + str(word_embeddings.shape))
        ...
        drop_out = self.drop(unpacked_out.contiguous())
        output = self.output(drop_out)# output shape: [sum(seq_lengths, 17]
